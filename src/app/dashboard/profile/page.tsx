...
import { User, Settings, Camera, CheckCircle } from 'lucide-react';
import React, { useState } from 'react';

// NOTE: The 'DashboardLayout' import has been removed to fix the double dashboard issue.
// The layout is automatically provided by the parent layout.tsx file.
...
        setTimeout(() => {
            setIsSaving(false);
            setShowSuccess(true); // Show custom success message
...
    return (
        // The DashboardLayout wrapper has been removed here.
        <div className="p-6 md:p-10 space-y-8 bg-gray-50 relative min-h-screen">
            
            {/* Custom Success Notification */}
            {showSuccess && (
                <div className="fixed top-2 right-2 md:top-6 md:right-6 z-50">
                    <div className="bg-green-500 text-white p-4 rounded-lg shadow-xl flex items-center transform transition-transform duration-300 animate-slide-in">
                        <CheckCircle className="w-5 h-5 mr-3" />
                        <span className="font-semibold">Profile settings updated successfully!</span>
                    </div>
                </div>
            )}
